...
def _formatAsNoteText(text: str, attribution: str = "PERSON") -> str:
    ...
    # Wrap the text to 80 characters, accounting for attribution prefix
    ...
    first_line_width: int = 80 - len(first_line_prefix)
    continuation_width: int = 80 - len(continuation_prefix)
