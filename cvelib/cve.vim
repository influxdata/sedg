...
" Standard keys
syn match cveKey "^\%(Candidate\|PublicDate\|PublicDateAtUSN\|CRD\|References\|Description\|Notes\|Mitigation\|CVSS\|Bugs\|Discovered-by\|Assigned-to\|Patches_[a-z0-9][a-z0-9+.-]\+\): *"
...
syn match cvePriorityKey "^Priority\(_[a-z0-9][a-z0-9+.-]\+\(_\(upstream\|snap\)\)\?\)\?: *"
...
syn match cveTagKey "^Tags_[a-z0-9][a-z0-9+.-]\+\(_\(upstream\|snap\)\)\?: *"
