...
"
" To use (use ~/.vim/syntax, ~/.vim/indent and ~/.vimrc for vim):
" $ mkdir -p ~/.config/nvim/syntax ~/.config/nvim/indent
" $ ln -s /path/to/sedg/vim/syntax/cve.vim ~/.config/nvim/syntax/cve.vim
" $ ln -s /path/to/sedg/vim/indent/cve.vim ~/.config/nvim/indent/cve.vim
"
